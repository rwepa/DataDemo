...
# 8/31(二) 07.R資料物件,判斷式與函數,群組分析與繪圖graphics
# 9/01(三) 08.資料操作dplyr,視覺化ggplot2,互動式表格視覺化
# 9/02(四) 09.地理資料視覺化leaflet,機器學習與深度學習應用
# 9/03(五) 10.基礎互動式shiny,進階互動式shinyServer佈署
